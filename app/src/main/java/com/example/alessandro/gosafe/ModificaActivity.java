...
public class ModificaActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        modificaUsernameText.setText(utente.getUsername().toUpperCase());
        modificaCognomeText.setText(utente.getCognome().toUpperCase());
        modificaNomeText.setText(utente.getNome().toUpperCase());
